...
export default {
  ...
  data() {
    return {
      lonlat: [[106.811063,29.558],[106.821363,29.555611],[106.796214,29.552671]], //经纬度
  ...
  mounted() {
    ...
    for (let i = 0; i < self.lonlat.length; i++) {
      ...
      markers.push({
        position: this.lonlat[i],
        icon2:require("../../../public/static/images/en3.png"),
        events: {
          click() {
            //弹窗信息
            console.info('2222')
            self.windows[i].content =
              `<div>
                  <div><span style="font-size: 17px;color: black">企业名称:</span><span style="color: black;font-size: 16px">麻柳制药厂</span></div>
                  <div><span style="font-size: 17px;color: black">联系电话:</span><span style="color: black;font-size: 16px">02356958874</span></div>
